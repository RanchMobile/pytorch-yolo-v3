...
3) Download the following: https://pjreddie.com/media/files/yolov3.weights  and place it on the root folder (where the detect.py file is located)
4) Open/Run terminal or command prompt as Admin
5) Run the following command from the root directory of the project 
```
python detect.py --images imgs --det det 
```

### These are from the fork:
